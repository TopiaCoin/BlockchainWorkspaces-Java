...
public class FileTagAlreadyExistsException extends Exception {
    /**
     * Constructs a new exception with {@code null} as its detail message. The cause is not initialized, and may
     * subsequently be initialized by a call to {@link #initCause}.
     */
    public FileTagAlreadyExistsException() {
    }
     ...
     *                method.
     */
    public FileTagAlreadyExistsException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public FileTagAlreadyExistsException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public FileTagAlreadyExistsException(Throwable cause) {
        super(cause);
    }
}
