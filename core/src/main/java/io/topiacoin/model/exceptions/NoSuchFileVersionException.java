...
public class NoSuchFileVersionException extends Exception {
    /**
     ...
     *                method.
     */
    public NoSuchFileVersionException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public NoSuchFileVersionException(String message, Throwable cause) {
        super(message, cause);
    }
