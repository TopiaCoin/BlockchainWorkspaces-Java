...
public class FileChunkAlreadyExistsException extends Exception {
    /**
     * Constructs a new exception with {@code null} as its detail message. The cause is not initialized, and may
     * subsequently be initialized by a call to {@link #initCause}.
     */
    public FileChunkAlreadyExistsException() {
    }
     ...
     *                method.
     */
    public FileChunkAlreadyExistsException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public FileChunkAlreadyExistsException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public FileChunkAlreadyExistsException(Throwable cause) {
        super(cause);
    }
}
