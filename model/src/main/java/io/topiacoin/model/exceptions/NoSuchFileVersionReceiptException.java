...
public class NoSuchFileVersionReceiptException extends Exception {
    /**
     * Constructs a new exception with {@code null} as its detail message. The cause is not initialized, and may
     * subsequently be initialized by a call to {@link #initCause}.
     */
    public NoSuchFileVersionReceiptException() {
    }
     ...
     *                method.
     */
    public NoSuchFileVersionReceiptException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public NoSuchFileVersionReceiptException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public NoSuchFileVersionReceiptException(Throwable cause) {
        super(cause);
    }
}
