...
public class NoSuchFileTagException extends Exception {
    /**
     * Constructs a new exception with {@code null} as its detail message. The cause is not initialized, and may
     * subsequently be initialized by a call to {@link #initCause}.
     */
    public NoSuchFileTagException() {
    }
     ...
     *                method.
     */
    public NoSuchFileTagException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public NoSuchFileTagException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public NoSuchFileTagException(Throwable cause) {
        super(cause);
    }
}
