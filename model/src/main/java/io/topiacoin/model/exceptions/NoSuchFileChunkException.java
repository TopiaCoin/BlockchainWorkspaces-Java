...
public class NoSuchFileChunkException extends Exception {
    /**
     * Constructs a new exception with {@code null} as its detail message. The cause is not initialized, and may
     * subsequently be initialized by a call to {@link #initCause}.
     */
    public NoSuchFileChunkException() {
    }
     ...
     *                method.
     */
    public NoSuchFileChunkException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public NoSuchFileChunkException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public NoSuchFileChunkException(Throwable cause) {
        super(cause);
    }
}
