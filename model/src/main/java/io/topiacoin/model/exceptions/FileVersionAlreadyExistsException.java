package io.topiacoin.model.exceptions;

import java.security.PrivilegedActionException;

public class FileVersionAlreadyExistsException extends Exception {
    /**
     * Constructs a new exception with {@code null} as its detail message. The cause is not initialized, and may
     * subsequently be initialized by a call to {@link #initCause}.
     */
    public FileVersionAlreadyExistsException() {
    }
     ...
     *                method.
     */
    public FileVersionAlreadyExistsException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public FileVersionAlreadyExistsException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public FileVersionAlreadyExistsException(Throwable cause) {
        super(cause);
    }
}
