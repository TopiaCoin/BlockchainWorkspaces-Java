...
public class RemoveValueResponse implements Message {

    public static final byte TYPE = (byte)0x84;

    private String key ;
    private boolean success ;

    public RemoveValueResponse() {
    }

    public RemoveValueResponse(ByteBuffer buffer) {
