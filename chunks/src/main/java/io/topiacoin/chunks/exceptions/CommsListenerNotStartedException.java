...
public class CommsListenerNotStartedException extends Exception {
     ...
     *                method.
     */
    public CommsListenerNotStartedException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public CommsListenerNotStartedException(String message, Throwable cause) {
        super(message, cause);
    }
}
