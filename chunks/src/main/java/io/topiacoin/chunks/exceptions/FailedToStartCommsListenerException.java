...
public class FailedToStartCommsListenerException extends Exception {
     ...
     *                method.
     */
    public FailedToStartCommsListenerException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public FailedToStartCommsListenerException(String message, Throwable cause) {
        super(message, cause);
    }
}
